    ...
    <section className="bg-black text-white">
      <div className="container !py-20">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center flex-col px-14">
            <h2 className="text-7xl tracking-[3px]">115</h2>
            <p className="text-xs font-medium">TOTAL LANDINGS</p>
          </div>
          <div className="flex items-center flex-col px-14">
            <h2 className="text-7xl tracking-[3px]">92</h2>
        ...
        <div className="py-20">
          <div className="grid grid-cols-3 gap-4">
            {data.map((item) => (
              <div class="bg-white rounded-lg border flex flex-col items-center border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <img
                    class="rounded-t-lg"
